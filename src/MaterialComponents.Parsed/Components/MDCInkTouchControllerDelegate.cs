...
namespace MaterialComponents
{
	...
	interface MDCInkTouchControllerDelegate
	{
        ...
        bool InkTouchController_shouldProcessInkTouchesAtTouchLocation (MDCInkTouchController inkTouchController, CGPoint location);
        ...
        void InkTouchController_didProcessInkView (MDCInkTouchController inkTouchController, MDCInkView inkView, CGPoint location);
	}
}
